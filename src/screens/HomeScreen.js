    ...
    return (
      <Wrapper title='Welcome'>
        <View style={{flexDirection: 'row'}}>
          <HomeScreenBtn text='Interval' action={() => this.props.navigation.navigate('IntervalWorkout')}/>
          <HomeScreenBtn text='Counter' action={() => this.props.navigation.navigate('CounterWorkout')}/>
        </View>
